...
@RestController
@RequestMapping("/api/searching-service-kafka")
public class SearchingServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SearchingServiceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SearchingServiceKafkaResource(KafkaProperties kafkaProperties) {
